                ...
                <div class="card-body">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                @if(!empty($data->foto))
                                    <img src="{{ asset('storage/' . $data->foto) }}" alt="Foto" style="max-width:200px; max-height:200px;" />
                                @else
                                    -
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>
                                @if(!empty($data->kategoris) && count($data->kategoris) > 0)
                                    @foreach($data->kategoris as $cat)
